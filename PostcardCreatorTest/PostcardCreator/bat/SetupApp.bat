...
:: Android packaging
set AND_CERT_NAME="PostcardCreator"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\PostcardCreator.p12
...
set IOS_PROVISION=cert\PostcardCreator.mobileprovision
